...
const OrganizationList = () => {
    ...
    return (
      <View style={{backgroundColor: COLORS.white, marginBottom: 2, paddingHorizontal: 20, paddingTop: 30}}>
          ...
          >
              {users.map((item) => (
                  <TouchableOpacity key={item.id} style={{ width: 74, padding: 5, marginRight: 10 }} onPress={() => navigation.navigate("Profile")}>
                      <LinearGradient
