import {View, Text, Image, TouchableOpacity, ScrollView, Share, FlatList, Dimensions} from 'react-native'
...
const EventDetailCensorScreen = ({ navigation }) => {
    const users = [
        {
            id: "1",
...
export default EventDetailCensorScreen