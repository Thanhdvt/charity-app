...
const Statistic = ({id}) => {
    ...
    return (
        <View style={{ backgroundColor: "white", marginBottom: 5, paddingVertical: 0, paddingHorizontal: 20, paddingBottom: 30 }}>
            <View style={{flexDirection: "row", alignItems: "center", justifyContent: "space-between"}}>
                ...
                >
                    <Picker.Item label="Tất cả" value="Tất cả" style={{fontWeight: "bold"}}/>
                    {data.map(item => (
